    ...
    <form action="/dashboard" method="POST" id="post-form">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="title" id="title"
                ...
                placeholder="Type post title" value="{{ old('title') }}" required autofocus>
        </div>
        <div class="mb-4">
            <label for="category" class="block mb-4 text-sm font-medium text-gray-900 dark:text-white">Category</label>
        ...
        <div class="mb-4">
            ...
            <textarea hidden name="body" id="body" rows="4"
...
@push('script')
    ...
    <script>
        ...
        const quileEditor = document.querySelector("#editor")


        postForm.addEventListener('submit', function(e) {
            e.preventDefault();
            const content = quileEditor.children[0].innerHTML;
