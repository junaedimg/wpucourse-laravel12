...
class PostDashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        // ! Bisa ditulisa langsung dengan namespace, caranya ini
        // return view('dashboard', ['post' => \App\Models\Post::latest()]);

        // ! Atau dengan import/require class
